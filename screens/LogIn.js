...
function LogIn() {
  const [kakaoResponse, setKakaoResponse] = useState("아직 응답 받지 못하였습니다.");
  const [serverResponse, setServerResponse] = useState("아직 응답 받지 못하였습니다.")
  const [kakaoAccessToken, setKakaoAccessToken] = useState("아직 응답 받지 못하였습니다.");
  const [serverAccessToken, setServerAccessToken] = useState("아직 응답 받지 못하였습니다.");
